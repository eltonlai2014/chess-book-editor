...
[CLAUDE.md](CLAUDE.md)；上一輪 session 的 handoff 細節在 [docs/HANDOFF.md](docs/HANDOFF.md)。
...
- **格式支援**：XQF 雙向 round-trip 已驗證；CBR/CBL（CCBridge3）讀寫工具已備，編輯器 UI 還沒接
...
3. 想動程式碼前先讀 [docs/HANDOFF.md](docs/HANDOFF.md)（上一輪 session 的設計脈絡）
